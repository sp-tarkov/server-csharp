...
public record LocationConfig : BaseConfig
{
    ...
    public Dictionary<string, HashSet<string>> OpenZones { get; set; }
    ...
    public Dictionary<string, HashSet<string>> ForcedLootSingleSpawnById { get; set; }
    ...
    public HashSet<string> TplsToStripChildItemsFrom { get; set; }

    /// <summary>
    ///     Map ids players cannot visit
    /// </summary>
    [JsonPropertyName("nonMaps")]
    public HashSet<string> NonMaps { get; set; }
}
...
public record ContainerRandomisationSettings
{
    ...
    public HashSet<string> ContainerTypesToNotRandomise { get; set; }
