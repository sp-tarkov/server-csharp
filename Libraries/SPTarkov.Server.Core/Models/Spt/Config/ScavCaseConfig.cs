...
public record ScavCaseConfig : BaseConfig
{
    ...
    public Dictionary<string, MinMax<double>> RewardItemValueRangeRub { get; set; }
    ...
    public HashSet<string> RewardItemParentBlacklist { get; set; }
...
public record AmmoRewards
{
    ...
    public Dictionary<string, MinMax<double>> AmmoRewardValueRangeRub { get; set; }
