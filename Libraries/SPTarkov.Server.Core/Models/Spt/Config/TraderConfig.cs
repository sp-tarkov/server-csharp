...
public record UpdateTime
{
    ...
    public MinMax<int> Seconds { get; set; }
}
...
public record FenceConfig
{
    ...
    public MinMax<int> WeaponPresetMinMax { get; set; }

    [JsonPropertyName("equipmentPresetMinMax")]
    public MinMax<int> EquipmentPresetMinMax { get; set; }
    ...
    public Dictionary<string, MinMax<int>?> ItemStackSizeOverrideMinMax { get; set; }
