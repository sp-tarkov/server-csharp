        ...
        : base(
            ...
            [
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return ragfairCallbacks.GetMarketPrice(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return ragfairCallbacks.StorePlayerOfferTaxAmount(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return ragfairCallbacks.SendReport(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return ragfairCallbacks.GetFleaPrices(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return ragfairCallbacks.GetFleaOfferById(
                            url,
