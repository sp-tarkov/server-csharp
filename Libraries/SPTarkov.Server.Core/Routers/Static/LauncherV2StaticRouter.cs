            ...
            [
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                        launcherV2Callbacks.Login(info as LoginRequestData),
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                        launcherV2Callbacks.PasswordChange(info as ChangeRequestData),
                    typeof(ChangeRequestData)
                ),
                new RouteAction(
                    "/launcher/v2/remove",
                    (url, info, sessionID, _) =>
                        launcherV2Callbacks.Remove(info as LoginRequestData),
                    typeof(LoginRequestData)
                ),
                new RouteAction(
                    "/launcher/v2/version",
