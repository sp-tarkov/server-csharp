        ...
        [
            new RouteAction(
                ...
                (
                    ...
                    sessionID,
                    output
                ) => { return achievementCallbacks.GetAchievements(url, info as EmptyRequestData, sessionID); }),
            new RouteAction(
                ...
                (
                    ...
                    sessionID,
                    output
                ) => { return achievementCallbacks.Statistic(url, info as EmptyRequestData, sessionID); })
        ]
    )
    {
    }
