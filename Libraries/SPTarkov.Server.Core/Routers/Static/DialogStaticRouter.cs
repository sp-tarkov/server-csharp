            ...
            [
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.GetChatServerList(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.GetMailDialogList(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.GetMailDialogView(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.GetMailDialogInfo(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.RemoveDialog(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.GetAllAttachments(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.CreateGroupMail(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.ChangeMailGroupOwner(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.AddUserToMail(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.RemoveUserFromMail(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.SendFriendRequest(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.AcceptAllFriendRequests(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.AcceptFriendRequest(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.DeclineFriendRequest(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        dialogueCallbacks.CancelFriendRequest(
                            url,
