            ...
            [
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        profileCallbacks.CreateProfile(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        profileCallbacks.ChangeNickname(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        profileCallbacks.ValidateNickname(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        profileCallbacks.GetReservedNickname(
                            url,
                ...
                new RouteAction(
                    "/client/profile/view",
                    (url, info, sessionID, output) =>
                        profileCallbacks.GetOtherProfile(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        profileCallbacks.GetProfileSettings(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        profileCallbacks.SearchProfiles(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                        profileCallbacks.GetMiniProfile(
                            url,
                ...
                new RouteAction(
                    "/launcher/profiles",
                    (url, info, sessionID, output) =>
                        profileCallbacks.GetAllMiniProfiles(
                            url,
                            info as EmptyRequestData,
                            sessionID
                        )
