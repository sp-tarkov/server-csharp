        ...
        : base(
            ...
            [
                new RouteAction(
                    ...
                    (url, _, sessionID, _) =>
                    {
                        return launcherCallbacks.Ping(url, null, sessionID);
                    }
                ),
                new RouteAction(
                ...
                new RouteAction(
                    ...
                    {
                        return launcherCallbacks.Login(url, info as LoginRequestData, sessionID);
                    },
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                    {
                        return launcherCallbacks.Register(url, info as RegisterData, sessionID);
                    },
                    typeof(RegisterData)
                ),
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                    {
                        return launcherCallbacks.Get(url, info as LoginRequestData, sessionID);
                    },
                    typeof(LoginRequestData)
                ),
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                    {
                        return launcherCallbacks.ChangeUsername(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                    {
                        return launcherCallbacks.ChangePassword(
                            url,
                            info as ChangeRequestData,
                            sessionID
                        );
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                    {
                        return launcherCallbacks.Wipe(url, info as RegisterData, sessionID);
                    },
                    typeof(RegisterData)
                ),
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                    {
                        return launcherCallbacks.RemoveProfile(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, _) =>
                    {
                        return launcherCallbacks.GetServerModsProfileUsed(
                            url,
