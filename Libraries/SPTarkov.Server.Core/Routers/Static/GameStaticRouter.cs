        ...
        : base(
            ...
            [
                new RouteAction(
                    ...
                    {
                        return gameCallbacks.GetGameConfig(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.GetGameMode(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.GetCurrentGroup(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.VersionValidate(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.ValidateGameVersion(
                            url,
                            info as EmptyRequestData,
                            sessionID
                        );
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.GameKeepalive(
                            url,
                            info as EmptyRequestData,
                            sessionID
                        );
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.GetRaidTime(
                            url,
                            info as GetRaidTimeRequest,
                            sessionID
                        );
                    },
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.GetSurveyView(
                            url,
                ...
                new RouteAction(
                    ...
                    (url, info, sessionID, output) =>
                    {
                        return gameCallbacks.SendSurveyOpinion(
                            url,
                            info as SendSurveyOpinionRequest,
                            sessionID
                        );
