    ...
    )
    {
        switch (url)
        {
            case ItemEventActions.EAT:
                return _healthCallbacks.OffraidEat(
                    pmcData,
                    body as OffraidEatRequestData,
                    sessionID
                );
            case ItemEventActions.HEAL:
                return _healthCallbacks.OffraidHeal(
                    pmcData,
                    body as OffraidHealRequestData,
                    sessionID
                );
            case ItemEventActions.RESTORE_HEALTH:
                return _healthCallbacks.HealthTreatment(
                    pmcData,
