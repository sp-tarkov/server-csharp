    ...
    )
    {
        switch (url)
        {
            case ItemEventActions.MOVE:
                return _inventoryCallbacks.MoveItem(
                    pmcData,
            ...
            case ItemEventActions.REMOVE:
                return _inventoryCallbacks.RemoveItem(
                    pmcData,
            ...
            case ItemEventActions.SPLIT:
                return _inventoryCallbacks.SplitItem(
                    pmcData,
            ...
            case ItemEventActions.MERGE:
                return _inventoryCallbacks.MergeItem(
                    pmcData,
            ...
            case ItemEventActions.TRANSFER:
                return _inventoryCallbacks.TransferItem(
                    pmcData,
            ...
            case ItemEventActions.SWAP:
                return _inventoryCallbacks.SwapItem(
                    pmcData,
                    body as InventorySwapRequestData,
                    sessionID
                );
            case ItemEventActions.FOLD:
                return _inventoryCallbacks.FoldItem(
                    pmcData,
                    body as InventoryFoldRequestData,
                    sessionID
                );
            case ItemEventActions.TOGGLE:
                return _inventoryCallbacks.ToggleItem(
                    pmcData,
                    body as InventoryToggleRequestData,
                    sessionID
                );
            case ItemEventActions.TAG:
                return _inventoryCallbacks.TagItem(
                    pmcData,
                    body as InventoryTagRequestData,
                    sessionID
                );
            case ItemEventActions.BIND:
                return _inventoryCallbacks.BindItem(
                    pmcData,
            ...
            case ItemEventActions.UNBIND:
                return _inventoryCallbacks.UnBindItem(
                    pmcData,
                    body as InventoryBindRequestData,
                    sessionID,
                    output
            ...
            case ItemEventActions.EXAMINE:
                return _inventoryCallbacks.ExamineItem(
                    pmcData,
            ...
            case ItemEventActions.CREATE_MAP_MARKER:
                return _inventoryCallbacks.CreateMapMarker(
                    pmcData,
            ...
            case ItemEventActions.DELETE_MAP_MARKER:
                return _inventoryCallbacks.DeleteMapMarker(
                    pmcData,
            ...
            case ItemEventActions.EDIT_MAP_MARKER:
                return _inventoryCallbacks.EditMapMarker(
                    pmcData,
            ...
            case ItemEventActions.OPEN_RANDOM_LOOT_CONTAINER:
                return _inventoryCallbacks.OpenRandomLootContainer(
                    pmcData,
            ...
            case ItemEventActions.HIDEOUT_QTE_EVENT:
                return _hideoutCallbacks.HandleQTEEvent(
                    pmcData,
            ...
            case ItemEventActions.REDEEM_PROFILE_REWARD:
                return _inventoryCallbacks.RedeemProfileReward(
                    pmcData,
            ...
            case ItemEventActions.SET_FAVORITE_ITEMS:
                return _inventoryCallbacks.SetFavoriteItem(
                    pmcData,
            ...
            case ItemEventActions.QUEST_FAIL:
                return _inventoryCallbacks.FailQuest(
                    pmcData,
            ...
            case ItemEventActions.PIN_LOCK:
                return _inventoryCallbacks.PinOrLock(
                    pmcData,
