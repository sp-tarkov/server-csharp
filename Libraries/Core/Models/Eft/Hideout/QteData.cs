...
public record QteData
{
    ...
    public Dictionary<QteEffectType, QteResult>? Results
    {
        get;
        set;
    }
...
public record QuickTimeEvent
{
    ...
    public Position? SuccessCoordinates
    {
        get;
        set;
    }
...
public record QteResult
{
    ...
    public List<QteEffect>? RewardEffects
    {
        get;
        set;
    }
...
public record QteEffect
{
    ...
    public List<SkillLevelMultiplier>? LevelMultipliers
    {
        get;
        set;
    }
...
public record AreaRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.Area;
...
public record TraderUnlockRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.TraderUnlock;
...
public record TraderLoyaltyRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.TraderLoyalty;
...
public record SkillRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.Skill;

    [JsonPropertyName("skillName")]
    [JsonConverter(typeof(JsonStringEnumConverter))]
    public SkillTypes? SkillName
    {
        get;
        set;
    }
...
public record ResourceRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.Resource;
...
public record ItemRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.Item;
...
public record ToolRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.Tool;
...
public record QuestRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.QuestComplete;
...
public record HealthRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.Health;
...
public record BodyPartBuffRequirement : QteRequirement
{
    ...
    public RequirementType? Type
    {
        get;
        set;
    } = Enums.Hideout.RequirementType.BodyPartBuff;
